...
import ProviderPopup from "../../popups/Provider/ProviderPopup";
import JoinSale from "../../popups/joinSale/JoinSale";
  ...
  return (
    <>
      ...
      <React.Fragment>
        ...
        <div
          className={
            showModal ? "bodyWrapper bodyWrapperBlured" : "bodyWrapper"
          }
        >
                ...
                <div className="section1Content">
                  ...
                  {forTalent ? (
                    <div className="section1ContentText">
                      ...
                      mobile application platform for artists such as singers,
                      dancers, magicians, comedians, actors, etc. to compete
                      with each other for rewards and title.
                    </div>
                  ) : null}

                  {forTalent ? null : (
                    <div className="section1ContentText section1ContentTextB">
                      As community, you can earn tokens for voting in contests.
                      We have designed an ecosystem that helps you engage like
                      never before, making Hood Legends a one of a kind and the
                      first ever talent platform for community.
                    </div>
                  )}
          ...
          <div className="section section3">
            <div className="sectionWrapper">
              ...
              <div className="section3text">
                ...
                talented people go through. Our platform gives a fair and equal
                chance to everyone.
              </div>
              ...
              <div className="section3itemsWrapper">
                ...
                <div className="section3item section3item2">
                  ...
                  <div className="section3itemText">
                    ...
                    people themselves. Who wins or who loses is entirely decided
                    by the people.
                  </div>
                </div>
                ...
                <div className="section3item">
                  ...
                  <div className="section3itemText">
                    ...
                    value such as voting rights, viewing rights, etc. instead of
          ...
          <div className="section section5">
            <div className="sectionWrapper">
              ...
              <div className="section3text">
                We are a diverse team of talented people who love what they do.
                ...
                >
                    ...
                    <div className="sectionWrapper">
                      ...
                      <div className="section1main">
                        ...
                        <div className="section1Content">
                          ...
                          {forTalent ? (
                            <div className="section1ContentText">
                              Hood Legends is a community driven, blockchain
                              based mobile application platform for artists such
                              as singers, dancers, magicians, comedians, actors,
                              etc. to compete with each other for rewards and
                              title.
                            </div>
                          ) : null}
                          ...
                          {forTalent ? null : (
                            <div className="section1ContentText section1ContentTextB">
                              As community, you can earn tokens for voting in
                              contests. We have designed an ecosystem that helps
                              you engage like never before, making Hood Legends
                              a one of a kind and the first ever talent platform
                              for community.
                            </div>
                          )}
                  ...
                  <div className="section section3">
                    <div className="sectionWrapper">
                      ...
                      <div className="section3text">
                        We are solving a huge problem that many professional and
                        talented people go through. Our platform gives a fair
                      ...
                      <div className="section3itemsWrapper">
                        <div className="section3item">
                          ...
                          <div className="section3itemText">
                            Our platform is open to anyone who wishes to compete
                            and showcase their talent. We have no barrier to
                            entry so everyone gets a fair chance.
                          </div>
                        </div>
                        ...
                        <div className="section3item">
                          ...
                          <div className="section3itemText">
                            We have designed an ecosystem that rewards stakers
                            true value such as voting rights, viewing rights,
                            etc. instead of unsustainable returns.
                          </div>
                        </div>
                        ...
                        <div className="section3item section3item2">
                          ...
                          <div className="section3itemText">
                            Our voters can enjoy exclusive rewards that will be
                            available only at our marketplace. We will offer
                  ...
                  <div className="section section4">
                    <div className="sectionWrapper">
                      ...
                      <div className="section3text">
                        A super diverse team of talented people known to get
                        things done. We have people from all around the globe
                        with a common goal, to make Web 3.0 accessible to all.
                      </div>
                      ...
                      <div className="section4itemsWrapper">
                        ...
                        >
                          ...
                          <div className="section4itemName">
                            ASLIHAN SARIGÜL
                          </div>
                          <div className="section4itemHint">
                            CONCEPT DEVELOPER
                        ...
                        <div className="section5outer">
                          ...
                          >
                            ...
                            <div className="section5item">
                              ...
                              <div className="section5itemLine">
                                <i class="fa-regular fa-circle"></i> Deploy
                                Smart Contracts
                              </div>
                              <div className="section5itemLine">
                                <i class="fa-regular fa-circle"></i> Security
                            ...
                            <div className="section5item">
                              ...
                              <div className="section5itemLine">
                                <i class="fa-regular fa-circle"></i> Presale A &
                                B
                              </div>
                              <div className="section5itemLine">
                                <i class="fa-regular fa-circle"></i> Legal
                                Advice
                              </div>
                              <div className="section5itemLine">
                                <i class="fa-regular fa-circle"></i> Progress
                            ...
                            <div className="section5item">
                              <div className="section5itemTitle">Q3 2023</div>
                              <div className="section5itemLine">
                                <i class="fa-regular fa-circle"></i> Alpha
                                Testing
                              </div>
                              <div className="section5itemLine">
                                <i class="fa-regular fa-circle"></i> Hood
                                Legends Trailer
                              </div>
                              <div className="section5itemLine">
                                <i class="fa-regular fa-circle"></i> Initiate
